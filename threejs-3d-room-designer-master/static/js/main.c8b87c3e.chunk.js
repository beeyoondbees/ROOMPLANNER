        ...
        57: function(e, t, a) {
            ...
            var pt = function(e, t) {
                            ...
                            if (!this.elWallContextMenu.isVisible()) {
                                ...
                                if (!this.mouseDown || this.activeCorner || this.activeWall || this.activeItem || (this.originX += this.lastX - this.rawMouseX, this.originY += this.lastY - this.rawMouseY, this.lastX = this.rawMouseX, this.lastY = this.rawMouseY, this.view.draw()), this.mode === te && this.mouseDown) {
                                    if (this.activeCorner) this.activeCorner.move(this.mouseX, this.mouseY);
                                        ...
                                        s += .05 * i, this.activeItem.rotate({}, s)
                                    }
                                    this.view.draw()
                                }
                ...
                Ht = function e(t) {
                    ...
                    }, this.model = new st(t.textureDir), this.three = new kt(this.model, t.threeElement, t.threeCanvasElement, {}), this.floorplanner = new St(t.floorplannerElement, this.model.floorplan, this)
                },
                Ct = a(34);
            a(52);
                    ...
                    function a(e) {
                        ...
                        return Object(_.a)(this, a), (l = t.call(this, e)).initializeBP3D = function() {
                            ...
                            return {
                                defaultMorph: t,
                                defaultStyles: i,
                                metadata: Object(f.a)(Object(f.a)({}, e), {}, {
                                    itemName: e.name,
                                    modelUrl: e.model,
                                    itemType: e.type
                                })
                        ...
                        return (e = t.call.apply(t, [this].concat(n))).renderMorphingSection = function() {
                            ...
                            return Object(v.jsx)(v.Fragment, {
                                children: t.hasOwnProperty("opened") ? Object(v.jsxs)(v.Fragment, {
                                    children: [Object(v.jsx)("hr", {}), Object(v.jsxs)("div", {
                                        className: "input-container",
                                        children: [Object(v.jsx)("label", {
